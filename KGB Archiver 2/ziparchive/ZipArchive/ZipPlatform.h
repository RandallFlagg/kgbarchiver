...
namespace ZipPlatform
{
	...
	*/
	...
	/**
		...
		\param uSizeNeeded
			The requested free space size in bytes. If set to <code>ZIP_U32_U64(-1)</code>, the 
			space availability is not checked.
	*/
	ZIP_API CZipString GetTmpFileName(LPCTSTR lpszPath = NULL, ZIP_U32_U64 uSizeNeeded = ZIP_U32_U64(-1));
	...
	*/
	...
	ZIP_API bool GetFileSize(LPCTSTR lpszFileName, ZIP_U32_U64& dSize); ///< Gets the file size.
